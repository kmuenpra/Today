...
class ViewController: UIViewController {
    ...
    @IBAction func findMatch(_ sender: Any) {
        ...
        if (n == 1) {
            ...
            writeOutgoingValue(data: "You have 24 hours to interact with" + " " + name1 + "\n");
            
        } else if (n == 2) {
            usernames.text = name2;
            profilePic.image = UIImage(named: "Steve");
            writeOutgoingValue(data: "You have 24 hours to interact with" + " " + name2 + "\n");
            
        } else if (n == 3) {
            usernames.text = name3;
            profilePic.image = UIImage(named: "Katara");
            writeOutgoingValue(data: "You have 24 hours to interact with" + " " + name3 + "\n");
            
        } else if (n == 4) {
            usernames.text = name4;
            profilePic.image = UIImage(named: "default");
            writeOutgoingValue(data: "You have 24 hours to interact with" + " " + name4 + "\n");
        }
